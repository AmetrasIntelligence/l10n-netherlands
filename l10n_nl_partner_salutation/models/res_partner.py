...
class ResPartner(models.Model):
    ...
    def get_salutation_name(self):
        ...
        return self.with_context(
            ...
            self.lastname, self.firstname, initials=self.initials, infix=self.infix
        )
    ...
    def _compute_salutation(self):
        ...
        for this in self:
            this.salutation = (
                this.salutation_manual
                if this.use_manual_salutations
    ...
    def _compute_salutation_address(self):
        ...
        for this in self:
            this.salutation_address = (
                this.salutation_address_manual
                if this.use_manual_salutations
