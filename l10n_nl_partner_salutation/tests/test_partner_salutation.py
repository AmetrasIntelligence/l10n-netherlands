...
class TestPartnerSalutation(TransactionCase):
    ...
    def test_salutation_male(self):
        ...
        self.assertEqual(partner.salutation, "Geachte heer %s" % salutation_name)
        self.assertEqual(partner.salutation_address, "De heer %s" % salutation_name)
    ...
    def test_salutation_female(self):
        ...
        salutation_name = partner.get_salutation_name()
        self.assertEqual(partner.salutation, "Geachte mevrouw %s" % salutation_name)
        self.assertEqual(partner.salutation_address, "Mevrouw %s" % salutation_name)
    ...
    def test_salutation_unknown(self):
        ...
        salutation_name = partner.get_salutation_name()
        self.assertEqual(
            partner.salutation, "Geachte heer of mevrouw %s" % salutation_name
        )
        self.assertEqual(
            partner.salutation_address, "De heer of mevrouw %s" % salutation_name
        )
